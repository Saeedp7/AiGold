...
class TicketAdmin(admin.ModelAdmin):
    ...
    search_fields = ('user__phone_number', 'created_at', 'updated_at', 'status')
...
class TicketMessageAdmin(admin.ModelAdmin):
    ...
    search_fields = ('ticket__title', 'user__phone_number')
    date_hierarchy = 'created_at'
    ordering = ('-created_at',)
...
class AttachmentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('ticket_message__ticket__title', 'ticket_message__user__phone_number')
