...
class Product(models.Model):
    ...
    price = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True)  # New field for storing calculated price
    ...
    stone_price = models.DecimalField(max_digits=20, decimal_places=2, blank=True, null=True, validators=[MinValueValidator(Decimal('0.00'))])
    stone_material = models.CharField(max_length=100, blank=True, null=True)
    is_new = models.BooleanField(default=False)
    is_featured = models.BooleanField(default=False)
    is_available = models.BooleanField(default=True)
    thumbnail = models.ImageField(upload_to='thumbnail/', validators=[validate_file_size], null=True, blank=True)
